               ...
               <nav>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-information" role="tabpanel" aria-labelledby="nav-information-tab">
                        <table class="table mt-2 party_info" v-if="ajaxData.partyData">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-right:0;">
                                        ...
                                        {{ajaxData.partyData.fullname_en}}</td>
                                </tr>
                                <tr>
                                    <td>Wiki EL</td>
...
<script>
    export default {
        ...
        methods:{
            ...
            getPartySpeeches(){
                var self = this;
                axios.get(this.$parent.host+'/api/v1/speeches/party/name/'+this.finalName)
            ...
            getPartyData(){
                var self = this
                axios.get(this.$parent.host+'/api/v1/party/name/'+this.finalName)
                .then(function(response){
                    console.log(response)
                    if(response.status == 200 && response.data.data){
