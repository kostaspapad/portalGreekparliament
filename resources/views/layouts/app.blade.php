...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding-bottom: 0;margin-bottom: 10px;">
            <a class="navbar-brand"><i class="fa fa-bullhorn" style="font-size:25px;"></i></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link {{ Request::path() === '/' ? 'active' : null }}" href="/">Home</a>
                    </li>
                    <li class="nav-item">
