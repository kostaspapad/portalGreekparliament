...
class CreateNewsletterTopQuestionsC1Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('top_questions_c1', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('top_questions_c1');
    }
}
